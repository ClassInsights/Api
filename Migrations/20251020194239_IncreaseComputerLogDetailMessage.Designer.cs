...
namespace Api.Migrations
{
    ...
    [Migration("20251020194239_IncreaseComputerLogDetailMessage")]
    partial class IncreaseComputerLogDetailMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.Database.ComputerLog", b =>
                {
                    b.Property<long>("ComputerLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("computer_log_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("ComputerLogId"));
                    ...
                    b.HasKey("ComputerLogId");

                    b.HasIndex("ComputerId", "Timestamp");

                    b.ToTable("computer_log");
                });
            ...
            modelBuilder.Entity("Api.Models.Database.ComputerLog", b =>
                {
                    b.HasOne("Api.Models.Database.Computer", "Computer")
                        .WithMany()
